const VocabularyFAQs = [
  ...
  },
  {
    ...
    answer: `Devant les Tribunaux judiciaires et les Cours d'appel, les justiciables doivent obligatoirement être représentés par un avocat inscrit dans un barreau correspondant au siège de la juridiction. Exemple : un avocat inscrit au barreau de Paris peut représenter ses clients devant le Tribunal judiciaire de Paris et la Cour d'appel de Paris. Ainsi, les avocats parisiens ne peuvent pas être postulants à Lyon, par exemple. Dans cette hypothèse, l'avocat parisien va faire appel à un confrère lyonnais, qui deviendra "avocat postulant". L’avocat postulant accomplit alors les actes de procédure auprès de la juridiction, tels que le placement de l’assignation ou la notification des conclusions. L'avocat parisien, dit avocat plaidant, rédigera tous les actes de la procédure et se chargera de plaider le dossier, le moment venu.`
  },
  {
    id: 10,
    question: "Que sont les conclusions ?",
    answer: `C'est le nom que l'on donne au document rédigé par un avocat portant l'argumentation de son client. Les conclusions peuvent être "en réplique", "récapitulatives", etc. Elles sont systématiquement transmises à la partie adverse qui a le droit d'en prendre connaissance et d'y répondre, par des conclusions, si elle le souhaite.`
  },
  {
    id: 11,
    question: "Qu'est-ce qu'une audience ?",
    answer: `L'audience est un "rendez-vous" judiciaire. Sa date, son heure et son lieu sont fixés par la juridiction. L'audience peut être "de mise en état", aussi appelée " audience de procédure" ou "de plaidoiries". Les audiences de mise en état ou de procédure sont simplement des étapes à l'occasion desquelles le magistrat vérifie le bon déroulement du processus de mise en état. L'audience des plaidoiries est celle au cours de laquelle la juridiction entend les plaidoiries des avocats, avant de mettre l'affaire en délibéré.`
  },
  {
    id: 12,
    question: "Qu'est que l'article 700 du Code de procédure civile ?",
    answer:
      "Il s'agit du texte qui permet de demander à la juridiction de condamner l'adversaire à vous verser une somme d'argent afin de vous dédommager des frais de procédure, d'avocat notamment, que vous engagez dans le cadre du procès. Les sommes accordées ne couvrent généralement pas le montant des dépenses réellement engagée."
  }
];

export default VocabularyFAQs;
