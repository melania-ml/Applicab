...
import { Typography, Button, TextField, InputAdornment, Icon, Card, CardContent } from '@mui/material';
...
function ForgotPassword() {
  ...
  const forgotPasswordState = useSelector(({ forgotPassword }) => forgotPassword.forgotPassword);
            ...
            <div className="w-full">
              {!isConfirmationMessage ? (
                ...
                <>
                  ...
                  />
                  <Button component={Link} to='/resetPassword/435345'>Jump</Button>
                </>
              )}
            </div>
          </CardContent>
